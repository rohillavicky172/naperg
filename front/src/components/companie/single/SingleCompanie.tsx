...
import OnboardingCompanieForm from '../../onboarding/OnboardingCompanieForm'
import { AppContext } from '../../AppContext'

import { Context } from '../../Context.type'
import SingleCompanieView from './SingleCompanieView'
...
const SingleCompanie = (props: Props) => {
        ...
        <Paper className="paperIn">
          {editMode ? (
            ...
            <div>
              ...
              <SingleCompanieView companie={data.companie} />
            </div>
          )}
        </Paper>
      </div>
