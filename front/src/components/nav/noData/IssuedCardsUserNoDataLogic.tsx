...
import UserIssuedCardsContainer from '../../issuedCard/list/issuedCardsUser/UserIssuedCardsContainer'
...
const IssuedCardsUserNoDataLogic = () => {
    ...
    <div className="paperOut">
      <Paper className="paperIn bgGrey">
        <NoDataTemplate
          ...
          subTitle={``}
          cta={`Get Started`}
          linkCta={`/issuedCards/${context.me.id}`}
...
export default IssuedCardsUserNoDataLogic
