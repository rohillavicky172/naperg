        ...
        <div className="paperOut">
          <Paper className="">
            <WarningAction
              ...
              message={'You currently have a Prepaid Account.'}
              message2={`OR, to avoid topping up your Balance, apply for a Pay-As-You-Go ("PAYG") account.`}
              actionText2={'Apply for PAYG Account'}
              shwowActionButton={true}
              onClick={() => history.push('/paymentSource/' + companieId)}
