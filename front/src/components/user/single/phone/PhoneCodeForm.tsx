...
const PhoneCodeForm = (props: Props) => {
  const phoneCodes = [
    ...
    { name: 'United States', dial_code: '+1', code: 'US' },
    { name: 'United States Minor Outlying Islands', dial_code: '+1581', code: 'UM' },
    ...
    { name: 'Western Sahara', dial_code: '+732', code: 'EH' },
  ...
  return (
    <>
      <Grid container>
        <Grid item xs={7} sm={7}>
          <FormControl className="width100per tal">
            <InputLabel htmlFor="phoneCode">{`Country`}</InputLabel>
            <Select className="" value={props.phoneCode} onChange={(e: any) => props.onChange(e.target.value)}>
              {phoneCodes.map((phoneCode, i) => (
                <MenuItem key={phoneCode.dial_code + i} value={phoneCode.dial_code}>
                  {phoneCode.name}
                </MenuItem>
              ))}
            </Select>
        ...
        <Grid item xs={5} sm={5}>
          <FormControl className="width100per">
            <InputLabel htmlFor="phoneCode">{``}</InputLabel>
            <Input disabled={true} id="phoneCode" type="text" value={props.phoneCode} onChange={(e) => {}} />
          </FormControl>
        </Grid>
      </Grid>
    </>
