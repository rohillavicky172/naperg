...
import UserRoleCompanieFormEmail from '../form/UserRoleCompanieFormEmail'
...
const SingleUserRoleCompanieEmailNotification = (props: Props) => {
  ...
  return (
    <div className="paperOut">
      <Paper className="paperIn">
        <h3>
          Transactionals Emails for {props.userRoleCompanie.user.firstName} {props.userRoleCompanie.user.lastName} (
              ...
              {(props.userRoleCompanie.companieRole === 'ADMIN' ||
                ...
                <Grid container alignItems="flex-end">
                  ...
                  <Grid item xs={12} md={8}>
                    ...
                    {props.userRoleCompanie.sendEmailMyInvoiceSuccessful ? 'Yes' : 'No'}
                  </Grid>
                </Grid>
              )}
              {props.userRoleCompanie.companie.isPersonal === false &&
                (props.userRoleCompanie.companieRole === 'ADMIN' ||
                  ...
                  <Grid container alignItems="flex-end">
                    ...
                    <Grid item xs={12} md={8}>
                      {isMobile && <Icon className="textSize9">subdirectory_arrow_right</Icon>}
                      {props.userRoleCompanie.sendEmailInvoiceSuccessful ? 'Yes' : 'No'}
                    </Grid>
                  </Grid>
                )}
              <Grid container alignItems="flex-end">
...
export default SingleUserRoleCompanieEmailNotification
