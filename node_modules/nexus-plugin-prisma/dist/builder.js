...
class SchemaBuilder {
    ...
    buildFieldConfig(config) {
        ...
        return Object.assign(Object.assign({}, additionalExternalPropsSuchAsPlugins), { args: this.buildArgsFromField(config), type: publisher_1.getNexusTypesCompositionForOutput(config.field.outputType).reduceRight(utils_1.apply, this.publisher.outputType(config.publisherConfig.type, config.field)), resolve: config.resolve });
    }
